...
<img src="/exercises/ex1/images/IAS1.png" width=50% height=50%>
   
3. Type the username and password and press **Log On**
   
   <img src="/exercises/ex1/images/IAS.png" width=50% height=50%>
